...
public class FakeStoreApiCrudTests {
    ...
    @Test
    public void testGetAllUsers_UnhappyPath_EmptyResponse_2() {
        given()
                .get(USERS_ENDPOINT)
                .then()
                .statusCode(200)
    ...
    @Test
    public void testGetAllUsers_UnhappyPath_EmptyResponse_4() {
        given()
                .get(USERS_ENDPOINT)
                .then()
                .statusCode(200)
    ...
    @Test
    public void testGetAllCarts_UnhappyPath_EmptyResponse() {
        given()
                .get(CARTS_ENDPOINT)
                .then()
                .statusCode(200)
